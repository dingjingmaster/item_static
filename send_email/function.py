...
def read_data(log_path, app):
    ...
    fr = open(log_path, "r")
    """
        gid{]app{]name{]author{]cp{]read_type \t uid|sort{]...
    """
    for line in fr.readlines():
        ...
        ml.append((book_info[0], book_info[1], book_info[2], book_info[3],
                   book_info[4], book_info[5], user_info))
    return ml


# 付费阅读情况
def charge_list(log_list):
    top = []
    ml = []
    md = {}
    id = {}
